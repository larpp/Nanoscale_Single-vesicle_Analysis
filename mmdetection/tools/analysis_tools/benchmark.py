...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='inference', # 2024.06.28, Change to inference
    ...
    parser.add_argument(
        '--max-iter', type=int, default=23, help='num of max iter') # 2024.06.28, Change defualt value to 23
    parser.add_argument(
        '--log-interval', type=int, default=2, help='interval of logging') # 2024.06.28, Change defualt value to 2
    parser.add_argument(
